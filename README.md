...
Two-page static site: a hero landing with six flavor cards plus Subscribe / Try once pricing, and a Shop Sachets offer page.
...
- Home is hero + feature/trust row + six flavor buy cards + the same Subscribe / Try once cards as shop. Shop stays a clean pricing page with a flavor list and contact line.
